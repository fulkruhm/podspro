  ...
  const allItems = [
    {
      ...
      icon: '📊',
      roles: ['admin', 'store_user', 'logistics_user', 'sysadmin'],
    },
    {
      id: 'inventory',
      label: 'Inventory Intelligence',
      icon: '📦',
      roles: ['admin', 'store_user', 'sysadmin'],
      description: 'Store-level product insights',
    },
    {
      id: 'forecastreview',
      ...
      description: 'Admin anomaly triage queue',
    },
    {
      id: 'logistics',
      label: 'Logistics Command',
      icon: '🚛',
      roles: ['admin', 'logistics_user', 'sysadmin'],
    },
    {
      id: 'assistant',
    ...
    },
    {
      ...
      icon: '🧾',
      roles: ['admin', 'sysadmin'],
      description: 'Cross-user action intelligence',
    },
    {
      id: 'usermanagement',
    ...
    <aside className="flex flex-col h-full text-white bg-slate-900 overflow-hidden">
      <div className="p-8 border-b border-slate-800/50">
        <h1 className="text-2xl font-black tracking-tighter text-blue-400 flex items-center">
          PODS
          <span className="ml-2 px-1.5 py-0.5 bg-blue-600/10 text-blue-400 text-[8px] border border-blue-400/20 rounded font-black tracking-widest">
            PRO
          </span>
        </h1>
      ...
      >
        <div className="flex flex-col space-y-3">
          <div className="flex items-center space-x-3">
            <div
              className={`w-10 h-10 rounded-xl flex-shrink-0 flex items-center justify-center text-sm font-black shadow-lg transition-transform group-hover:scale-105 ${
                activeTab === 'profile'
          ...
          >
            <div className="flex items-center text-[10px] text-slate-400 font-medium">
              ...
              <span
                className={`truncate ${activeTab === 'profile' ? 'text-blue-50' : 'text-slate-400'}`}
              >
            ...
            <div className="flex items-center text-[10px] text-slate-400 font-medium">
              <span className="w-4">🆔</span>
              <span
                className={`truncate italic ${activeTab === 'profile' ? 'text-blue-50' : 'text-slate-500'}`}
              >
                @{user.username}
              </span>
            </div>
